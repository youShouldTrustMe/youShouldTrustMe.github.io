...
![ASCII表示](https://gitee.com/you-trust-me/pictures/raw/master/Images/image-20260320083449472.png)

> [!note]
>
> 注意：我们使用txt文件打开的时候显示的是ASCII表示，也就是一个字符串。实际上一行数据的原始数据如下图左侧所示，使用txt打开的如右图所示。
>
> ![Imhex打开](https://gitee.com/you-trust-me/pictures/raw/master/Images/image-20260320083529742.png)
>
...
1. 创建dll项目
   ...
   ![创建DLL新项目](https://gitee.com/you-trust-me/pictures/raw/master/Images/image-20260320084245979.png)

   注意，这里记住dll的路径，防止之后找不到，可以勾选`将解决方案和项目放在同一目录下`，这样就不会找不到文件了

   ![配置项目属性](https://gitee.com/you-trust-me/pictures/raw/master/Images/image-20260320084420310.png)
...
3. 编译生成
   ...
   ![生成dll](https://gitee.com/you-trust-me/pictures/raw/master/Images/image-20260320090458137.png)
