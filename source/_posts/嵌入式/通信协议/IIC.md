...
![ICC电路结构](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082152133.png)
...
- 由于是半双工的协议，所以主机的SDA在发送的时侯是输出，在接收的时候是输入，同样的，从机的SDA也会在输入和输出之间反复切换，为了协调这一点，==禁止所有设备输出强上拉的高电平，采用外置弱上拉电阻加开漏输出的电路结构==。
  ...
  ![内部结构](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082248208.png)
...
![开始信号](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082653565.png)
...
![结束信号](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082715140.png)

*`发送`*

发送一个字节：SCL低电平期间，主机将数据位依次放到SDA线上(高位先行)，然后释放SCL,从机将在SCL高电平期间读取数据位所以SCL高电平期间SDA不允许有数据变化，依次循环上述过程8次，即可发送一个字节

![发送过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082540921.png)
...
![发送应答](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082843982.png)

*`接收`*

接收一个字节：SCL低电平期间，从机将数据位依次放到SDA线上(高位先行)，然后释放SCL,主机将在SCL高电平期间读取数据位所以SCL高电平期间SDA不允许有数据变化，依次循环上述过程8次，即可接收一个字节（主机在接收之前，需要释放SDA)

![接收过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082829084.png)
...
![接收应答](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108082900806.png)

## 基本读写过程

![数据格式](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108083805086.png)
...
![主机写数据到从机](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108083541531.png)

*`读数据 `*

![主机由从机中读数据](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108083605451.png)
...
![地址和数据方向](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108083929304.png)
...
![完整的传输过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20260108084139726.png)
