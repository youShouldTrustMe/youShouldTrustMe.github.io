...
cover: https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251128134435579.png
categories:
  - 嵌入式
tags:
  - 外设组件
...
![时钟信号](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251128134435579.png)
...
1. 内部时钟（RC震荡器）
   ...
   ![RC震荡内部时钟](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260423162455298.png)

   使用RC震荡电路产生时钟，通过VDD给电容充电，产生一个上升的趋势，当产生电压达到一定的阈值后，N-Mos管打开，将电容电能泄放，此时就产生一个下降的趋势，从而产生振荡曲线。**当然，这只是一个简易的示意图，实际上的实现会更加复杂。**
...
2. 外部晶振（Crystal / XTAL）
   ...
   ![外部晶振电路](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260424145359895.png)
