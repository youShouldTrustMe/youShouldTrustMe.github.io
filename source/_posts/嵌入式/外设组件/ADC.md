...
cover: https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201085552094.png
categories: 
  - 嵌入式
tags:
  - 外设组件
...
![并联比较型](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251128155931854.png)

## 逐次逼近型

![逐次逼近型](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251128160110838.png)
...
![ADC原理框图](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201085552094.png)

![结构框图](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251128162249955.png)
...
![ADC单端输入](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201091756528.png)
...
![ADC差分输入](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201092054502.png)
...
![差分输入信号与码字的关系](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201092500644.png)
...
![ADC校准时序](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201093022033.png)
...
![ADC转换时序](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201093619441.png)
...
![ADC采样时序](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251201093432296.png)
...
1. 全自动触发模式：软件或硬件触发事件启动 ADC 转换后，ADC 会顺序采样所有被使能的通道，单个通道采样完成后，EOC（End of Conversion）标志置位，所有通道采样完成后，EOS（End ofSequence）标志置位，本次转换结束。
   ...
   3. 触发事件：重复上述过程
      ...
      ![ADC单次转换全自动触发模式](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251202083710278.png)
...
2. 半自动触发模式：软件或硬件触发事件只会让 ADC 启动一次，转换一个使能通道。比如通道 0、3、5 被使能
   ...
   5. 触发事件：通道 3 被采样，产生 EOC
      ...
      ![ADC单次转换的半自动触发模式](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251202083945396.png)

### 连续转换

触发事件到来后，所有使能通道被采样，并且 ADC 不会自动停止，而是循环采样，直到软件停止ADC。

![连续转换](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251202084137636.png)
...
2. 硬件触发
   ...
   ![ADC转换硬件触发源](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/image-20251202084853070.png)
