...
![人类类比RTOS](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325170208923.png)
...
这种做法，在软件开发上就是使用操作系统，在单片机里叫做使用RTOS。RTOS的意思是：Real-time operating system，实时操作系统。

我们使用的Windows也是操作系统，被称为通用操作系统。使用Windows时，我们经常碰到程序卡死、停顿的现象，日常生活中这可以忍受。

但是在电梯系统中，你按住开门键时如果没有即刻反应，即使只是慢个1秒，也会夹住人。在专用的电子设备中，“实时性”很重要。
...
![任务处理](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325171222232.png)



用人来类比电子产品

![人类类比电子产品](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325171333894.png)

在电子系统中，CPU就是大脑，CPU有很多种类别，被称为架构。常见的有：
...
首先从[FreeRTOS™ - FreeRTOS™](https://www.freertos.org/)上下载文件。内核文件夹为`FreeRTOS-LTS\FreeRTOS\FreeRTOS-Kernel`，其中文件树为（删除了部分文件夹，这里展示keil文件夹）：
...
我们需要使用的源文件位于`FreeRTOS`中。配置移植教程可以看[Build your first FreeRTOS project - FreeRTOS™](https://www.freertos.org/Documentation/01-FreeRTOS-quick-start/01-Beginners-guide/03-Build-your-first-project)
...
![FreeRTOS的同步互斥的方法](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325165525372.png)
...
![队列常规操作](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325165544755.png)

==队列先入先出，从队尾入队，队头出队，使用环形缓冲区实现==，更详细的：

![队列详细过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325165703811.png)
...
![程序的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172439605.png)

任务的调度情况如下图所示：

![任务调度图](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172447771.png)
...
![不同的任务的不同id](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172459260.png)
...
![程序的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172517698.png)

任务调度情况如下图所示：

![任务调度情况](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172523971.png)
...
> 运行结果：
>
> ![传输大块数据运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172543115.png)
...
>
> ![邮箱案例](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172553861.png)
>
> 运行结果：
>
> ![邮箱的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172603464.png)
...
![信号量](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172615523.png)
...
![使用二进制信号来同步](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172639830.png)



运行结果如下图所示，即使发送任务连续释放多个信号量，也只能成功1次。释放、获得信号量是一一对应的。

![使用二进制信号来同步结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172647833.png)
...
![防止数据丢失过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172705587.png)

程序运行结果如下，数据未丢失：

![防止数据丢失的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172719840.png)
...
![使用计数型信号量运行过程](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172733413.png)

运行结果如下：

![使用计数型信号量运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172752849.png)
...
![c代码语句的实质](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172816387.png)
...
![使用互斥量前后结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172841445.png)
...
![谁上锁就由谁解锁？](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172909037.png)

程序运行结果如下：

![谁上锁就由谁解锁的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172924458.png)
...
![优先级反转](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172943595.png)

程序运行的时序图如下：

![优先级反转运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325172953704.png)
...
![优先级继承运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325173005661.png)
...
![递归锁](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325173029903.png)

程序运行结果如下图所示：

![递归锁运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260325173039345.png)
...
![事件组图](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144446368.png)
...
![等待多个事件执行顺序](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144515482.png)

运行结果如下所示：

![等待多个事件的结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144524095.png)
...
![任务同步结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144538992.png)
...
![队列、信号量、事件组的通知方式](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144549542.png)

使用任务通知时，任务结构体TCB中就包含了内部对象，可以直接接收别人发过来的"通知"：

![任务通知执行方式](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144619103.png)
...
![传输计数值运行代码](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144650157.png)

运行结果如下：

![传输计数值运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144704882.png)
...
![传输任意值代码](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144719023.png)

传输任意值的传输结果如下

![传输任意值的运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144729887.png)
...
![软件定时器的运行状况](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144844515.png)
...
![守护任务](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144856349.png)
...
1. 守护任务的优先性级较低
   ...
   ![守护任务优先级较低](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144910985.png)
...
2. 例子2：守护任务的优先性级较高
   ...
   ![守护任务优先级较高](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144926710.png)
...
![软件定时器状态机转换](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327144944379.png)
...
![软件定时器的一般使用](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327145022169.png)

运行结果如下图所示：

![软件定时器的一般使用的结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327145032976.png)
...
![消除抖动](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327145042639.png)
...
![消除抖动运行结果](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327145057032.png)
...
![中断延迟](https://cdn.jsdelivr.net/gh/youShouldTrustMe/MyPictures@main/Images/20260327145118422.png)
